...
// GetFlusherCheckpoint provides a mock function with no fields
func (_m *MockRecoveryStorage) GetFlusherCheckpoint() *utility.WALCheckpoint {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetFlusherCheckpoint")
	}
...
// MockRecoveryStorage_GetFlusherCheckpoint_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFlusherCheckpoint'
type MockRecoveryStorage_GetFlusherCheckpoint_Call struct {
	*mock.Call
}

// GetFlusherCheckpoint is a helper method to define mock.On call
func (_e *MockRecoveryStorage_Expecter) GetFlusherCheckpoint() *MockRecoveryStorage_GetFlusherCheckpoint_Call {
	return &MockRecoveryStorage_GetFlusherCheckpoint_Call{Call: _e.mock.On("GetFlusherCheckpoint")}
}

func (_c *MockRecoveryStorage_GetFlusherCheckpoint_Call) Run(run func()) *MockRecoveryStorage_GetFlusherCheckpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockRecoveryStorage_GetFlusherCheckpoint_Call) Return(_a0 *utility.WALCheckpoint) *MockRecoveryStorage_GetFlusherCheckpoint_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRecoveryStorage_GetFlusherCheckpoint_Call) RunAndReturn(run func() *utility.WALCheckpoint) *MockRecoveryStorage_GetFlusherCheckpoint_Call {
	_c.Call.Return(run)
	return _c
}
