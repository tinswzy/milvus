...
type WALCheckpoint struct {
	...
	// TODO 记录switch MQ msg与否
	IsSwitchMqMsg bool   `protobuf:"varint,6,opt,name=is_switch_mq_msg,json=isSwitchMqMsg,proto3" json:"is_switch_mq_msg,omitempty"`
	TargetMq      string `protobuf:"bytes,7,opt,name=target_mq,json=targetMq,proto3" json:"target_mq,omitempty"`
}
...
func (x *WALCheckpoint) GetIsSwitchMqMsg() bool {
	if x != nil {
		return x.IsSwitchMqMsg
	}
	return false
}

func (x *WALCheckpoint) GetTargetMq() string {
	if x != nil {
		return x.TargetMq
	}
	return ""
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x09, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6d, 0x61, 0x78, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x8d,
	...
	0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x27, 0x0a, 0x10, 0x69, 0x73, 0x5f, 0x73,
	0x77, 0x69, 0x74, 0x63, 0x68, 0x5f, 0x6d, 0x71, 0x5f, 0x6d, 0x73, 0x67, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0d, 0x69, 0x73, 0x53, 0x77, 0x69, 0x74, 0x63, 0x68, 0x4d, 0x71, 0x4d, 0x73,
	0x67, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x6d, 0x71, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x4d, 0x71, 0x22, 0xca,
	...
	0x54, 0x4f, 0x4e, 0x45, 0x10, 0x05, 0x2a, 0xaa, 0x04, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61,
	...
	0x54, 0x49, 0x4f, 0x4e, 0x10, 0x0d, 0x12, 0x1b, 0x0a, 0x16, 0x53, 0x54, 0x52, 0x45, 0x41, 0x4d,
